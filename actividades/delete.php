...
// set actividad id to be deleted
...
if($actividad->delete()){
    ...
    // tell the user
    echo json_encode(array("message" => "La actividad fue eliminada."));
}
...
// if unable to delete the evento
    ...
    // tell the user
    echo json_encode(array("message" => "No se pudo eliminar la actividad."));
}
